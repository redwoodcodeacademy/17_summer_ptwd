angular
  ...
  .controller("userController", function($scope) {
    ...
    function User(fname, lname, email, phone, dateOfBirth, streetOne, streetTwo, city, state, zip, cardNumber, cardType, security) {
    ...
    $scope.addUser = function() {
      $scope.users.unshift(new User($scope.fName, $scope.lName, $scope.email, $scope.phone, $scope.dob, $scope.street1, $scope.street2, $scope.city, $scope.state, $scope.zip, $scope.ccNum, $scope.cardType, $scope.security))
    ...
    $scope.saveUser = function() {
      $scope.users.splice(currentUserIndex, 1, new User($scope.fName, $scope.lName, $scope.email, $scope.phone, $scope.dob, $scope.street1, $scope.street2, $scope.city, $scope.state, $scope.zip, $scope.ccNum, $scope.cardType, $scope.security))
